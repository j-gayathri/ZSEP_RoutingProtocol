...
figure(1);
legend('Advanced nodes : o','Normal nodes : x','Base station : *');
hold off
...
figure(2);
r=0:rmax;
plot(r,STATISTICS.ALLIVE3(r+1),'--',r,STATISTICS.ALLIVE(r+1),'.',r,STATISTICS.ALLIVE2(r+1),'-.',r,STATISTICS4.ALLIVE2(r+1),'-')
legend('LEACH   m=0.4,a=2','SEP   m=0.4,a=2','Z-SEP  m=0.4,a=2', 'improved  m=0.4,a=2');
xlabel('Rounds');
ylabel('Allive Nodes');

figure(3);
plot(r,STATISTICS.DEAD3(r+1),'--',r,STATISTICS.DEAD(r+1),'.',r,STATISTICS.DEAD2(r+1),'-.',r,STATISTICS4.DEAD2(r+1),'-')
legend('LEACH  m=0.4,a=2','SEP    m=0.4,a=2','Z-SEP  m=0.4,a=2','improved  m=0.4,a=2');
xlabel('Rounds');
ylabel('Dead Nodes');

figure(4);
plot(r,STATISTICS.packets_TO_BS(r+1),'--',r,STATISTICS.packets_TO_BS3(r+1),'.',r,STATISTICS.PACKETS_TO_BS2(r+1),'-.',r,STATISTICS4.PACKETS_TO_BS2(r+1),'-')
legend('LEACH   m=0.4,a=2','SEP    m=0.4,a=2','Z-SEP m=0.4,a=2','improved  m=0.4,a=2');
xlabel('Rounds');
